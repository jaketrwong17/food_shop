<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                <meta charset="UTF-8">
                <title>Cập nhật Chính sách</title>
                ...
                <div class="d-flex" id="wrapper">
                    ...
                    <div id="page-content-wrapper">
                        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom px-4 py-3">
                            <h4 class="mb-0 text-dark fw-bold text-uppercase">Cập Nhật Chính Sách</h4>
                        </nav>

                        <div class="container-fluid px-4 py-4">
                            <form:form action="/admin/policy/update" method="POST" modelAttribute="policy">
                                <form:hidden path="id" />
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <form:input path="name" class="form-control"
                                                        placeholder="VD: Chính sách đổi trả..." required="true" />
                                                </div>
                                                ...
                                                <div class="mb-4 form-check form-switch">
                                                    ...
                                                    <label class="form-check-label fw-bold small"
                                                        for="activeStatus">Kích hoạt (Hiển thị trên web)</label>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-end gap-2 mt-4 border-top pt-3">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-warning text-white px-5 fw-bold">

            ...
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom px-4 py-3">
                        <h4 class="mb-0 text-dark fw-bold">Thêm Thương Hiệu Mới</h4>
                    </nav>
                                    ...
                                    <div class="card-body p-4">
                                        <form:form action="/admin/brand/create" method="POST" modelAttribute="newBrand"
                                            ...
                                            <div class="d-grid gap-2">
                                                <button type="submit" class="btn btn-primary btn-lg">Lưu thương
                                                    hiệu</button>
                                                <a href="/admin/brand" class="btn btn-light btn-lg text-secondary">Hủy
                                                    bỏ</a>
                                            </div>
                                        </form:form>
                                    </div>
